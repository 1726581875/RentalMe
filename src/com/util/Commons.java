...
public class Commons {
    public static final Object CREATE_ORDER_FAIL = "创建订单错误";

    public static String SERVER_URI = "http://localhost:8080/RentalMe";
    
    public static String UN_LOGIN = "未登录";
    ...
    public static Object INSUFFICIENT_BALANCE = "余额不足";
